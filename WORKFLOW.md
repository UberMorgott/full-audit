...
- It runs the heavy, **read-only** audit waves + scoring of the full-audit system (**v1.13.0 engine**) and returns **ONE structured findings object**.
- It is **NOT** the audit logic rewritten. The following are preserved **verbatim from the full-audit README v1.13.0**:
